...
For documentation work, use `docs/DOCUMENTATION_INDEX.md` to select only the
relevant sources. A CBM code index does not replace the documentation inventory
or prove that host integrations are active.
