...
| `download-and-digester` (script) | Descarga libros desde Z-Library y los indexa en `memorwise`. | `bash scripts/downloader.sh "Deep Learning" pdf` |
| `memorwise` | Indexa contenido para búsqueda futura en la memoria. | Automático vía `downloader.sh`. |
