...
def classify_task_structure(request: str) -> Dict[str, Any]:
    ...
    # Si hay "sin información", "no hay datos", "falta información", "no conocemos" -> priorizar human_review
    uncertainty_indicators = [
        ...
        "no conocemos" in request_lower,
        "no sabemos" in request_lower
    ]
